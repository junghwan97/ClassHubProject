...
- 구글 소셜 로그인
    인증 : 구글 소셜 로그인(OAuth2) 후 JWT 발급
    인가 : JWT를 통한 경로별 접근 권한 부여

- 게시글 및 댓글(질의 응답, 스터디 모집) CRUD API
    게시판 CRUD 구현
    게시글 상세 페이지, 댓글, 좋아요 CRUD
    게시글 제목, 본문 단어 기반 검색 기능 구현
    게시글 조회 필터(좋아요, 댓글 순) 기능 구현
- Ubuntu 서버 구축 및 프로젝트 배포 (카페24)
    카페24에서 Ubuntu 서버를 설정하여 애플리케이션 배포
    이미지 파일을 서버에 저장하고, 게시글에서 이미지 조회 기능 구현
- Swagger
    API 문서화를 통해 프론트엔드와 협업

...
- 게시글 및 댓글(질의 응답, 스터디 모집) CRUD API<br>
    >게시판 CRUD 구현<br>
    >게시글 상세 페이지, 댓글, 좋아요 CRUD<br>
    >게시글 제목, 본문 단어 기반 검색 기능 구현<br>
    >게시글 조회 필터(좋아요, 댓글 순) 기능 구현<br>
- Ubuntu 서버 구축 및 프로젝트 배포 (카페24)<br>
    >카페24에서 Ubuntu 서버를 설정하여 애플리케이션 배포<br>
    >이미지 파일을 서버에 저장하고, 게시글에서 이미지 조회 기능 구현<br>
- Swagger<br>
    >API 문서화를 통해 프론트엔드와 협업<br>
